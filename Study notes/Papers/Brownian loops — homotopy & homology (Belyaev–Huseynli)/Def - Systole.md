...
| $n_{\mathrm{sys}}$ | $:=\#\{\gamma\in\mathcal{P}_X:\ell_\gamma=\ell_{\mathrm{sys}}\}\in\mathbb{Z}_{\geq1}$ — the multiplicity |
...
>
> **Produces.** A number $\ell_{\mathrm{sys}}\in(0,\infty)$ and a multiplicity $n_{\mathrm{sys}}\in\mathbb{Z}_{\geq1}$.
>
...
**Instance.** Closed genus-2 surface: $\ell_{\mathrm{sys}}>0$, attained by finitely many geodesics. Typically $n_{\mathrm{sys}}=1$; but hyperelliptic and other symmetric surfaces have $n_{\mathrm{sys}}>1$, and (F1) only bounds it.
