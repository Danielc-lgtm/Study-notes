...
> >
> > **The chart $U_1$.** Define the smooth section $s_1(\eta)=\tfrac{1}{\sqrt{1+\lvert\eta\rvert^2}}(1,\eta)$ over $U_1$ by the identical construction (now $w_1\ne 0$, $\eta=w_2/w_1$). With $\lvert w_1\rvert^2=\frac{1}{1+\lvert\eta\rvert^2}$, $\lvert w_2\rvert^2=\frac{\lvert\eta\rvert^2}{1+\lvert\eta\rvert^2}$, $w_1\overline{w_2}=\frac{\overline{\eta}}{1+\lvert\eta\rvert^2}$,
> > $$\Phi_1(\eta)=\operatorname{Hopf}(s_1)=\frac{1}{4\lvert\eta\rvert^2+1}\bigl(4\overline{\eta},\ 4\lvert\eta\rvert^2-1\bigr).$$
> > Its third coordinate $\frac{4\lvert\eta\rvert^2-1}{4\lvert\eta\rvert^2+1}=1-\frac{2}{4\lvert\eta\rvert^2+1}\in[-1,1)$ never equals $1$, so the image avoids the north pole $N=(0,1)$. The same inversion as above (replacing "from the south pole" by "from the north pole") gives the smooth inverse $(y,y_3)\mapsto\frac{2\overline{y}}{1-y_3}$ on $S^2\setminus\{N\}$; one checks $\sigma_1(\Phi_1(\eta))=\eta$ and $\Phi_1(\sigma_1(y,y_3))=(y,y_3)$ verbatim, using $\lvert y\rvert^2=(1-y_3)(1+y_3)$. Hence $\Phi_1\colon\mathbb{C}\to S^2\setminus\{N\}$ is a diffeomorphism.
> >
> > **Local diffeomorphism and surjectivity.** The affine coordinate maps $c_2\colon U_2\to\mathbb{C}$, $[w]\mapsto\zeta$, and $c_1\colon U_1\to\mathbb{C}$, $[w]\mapsto\eta$, are diffeomorphisms onto $\mathbb{C}$ (part of the smooth structure of $\mathbb{CP}^1$; see [[Def - Complex Projective Space as a Quotient]]). On $U_2$ we have $\widetilde{\operatorname{Hopf}}=\Phi_2\circ c_2$, a composition of the diffeomorphism $c_2\colon U_2\to\mathbb{C}$ with the diffeomorphism $\Phi_2\colon\mathbb{C}\to S^2\setminus\{S\}$, hence a diffeomorphism $U_2\to S^2\setminus\{S\}$; similarly $\widetilde{\operatorname{Hopf}}=\Phi_1\circ c_1$ is a diffeomorphism $U_1\to S^2\setminus\{N\}$. Since $U_1,U_2$ are open and cover $\mathbb{CP}^1$, every point of $\mathbb{CP}^1$ has an open neighbourhood on which $\widetilde{\operatorname{Hopf}}$ restricts to a diffeomorphism onto an open subset of $S^2$; that is, $\widetilde{\operatorname{Hopf}}$ is a local diffeomorphism. Finally $\widetilde{\operatorname{Hopf}}(\mathbb{CP}^1)\supseteq\widetilde{\operatorname{Hopf}}(U_2)\cup\widetilde{\operatorname{Hopf}}(U_1)=(S^2\setminus\{S\})\cup(S^2\setminus\{N\})=S^2$, so $\widetilde{\operatorname{Hopf}}$ is surjective.
