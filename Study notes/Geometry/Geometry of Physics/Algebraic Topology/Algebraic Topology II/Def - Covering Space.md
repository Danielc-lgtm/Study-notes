...
> A covering map is a fibre bundle with discrete fibre. The general theory of **fibre bundles** allows the fibre to be any topological space and the structure group to be any topological group acting on the fibre. Principal bundles ($G$-torsors) are the "fundamental" fibre bundles; vector bundles come from associated-bundle constructions. The whole machinery of **gauge theory** generalises the covering-space picture.
