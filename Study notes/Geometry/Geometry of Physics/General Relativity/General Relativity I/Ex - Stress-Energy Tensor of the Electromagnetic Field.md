...
2. **Operation 5 from the topic page** (Use contracted Bianchi to deduce conservation): Once we have $T_{\mu\nu}$, conservation $\nabla^\mu T_{\mu\nu} = 0$ is automatic when the matter equation of motion (Maxwell's equation) holds — this is a manifestation of the [[Def - Diffeomorphism|diffeomorphism]] invariance of the matter action plus Maxwell's equations.
