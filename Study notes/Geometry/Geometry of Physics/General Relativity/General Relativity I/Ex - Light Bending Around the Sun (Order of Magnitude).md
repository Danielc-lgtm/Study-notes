...
**(a) Derive this formula from null [[Def - Geodesic|geodesics]] in the Schwarzschild metric.**
...
**The light-cone structure of GR is what enables gravitational lensing.** Light travels on null geodesics, which are bent by gravity (curvature of spacetime). This means distant gravitational fields create observable *images* of the lensed light — the field of **gravitational lensing**. Strong lensing produces multiple images, arcs, and Einstein [[Def - Ring|rings]] (when the source is exactly behind a mass); weak lensing produces small distortions of background galaxies, used to map dark matter distributions in galaxy clusters. The Eddington calculation here is the simplest instance: a single light ray bent by a single mass. The trigger: any time light propagation passes through gravitational fields, expect geometric distortions of order $GM/(bc^2)$ relative to the unperturbed paths.
