...
**3. The Maurer-Cartan equation as a special case.** On a Lie group $G$ with left-invariant frame $(e_a)$ and dual coframe $(\sigma^a)$, the Maurer-Cartan equation is $d\sigma^a + \tfrac{1}{2}c^a_{bc}\sigma^b \wedge \sigma^c = 0$, where $c^a_{bc}$ are the structure constants of $\mathfrak{g}$. Show that this is exactly the first structural equation for the Weitzenböck connection $\nabla \equiv 0$ on left-invariant frames, with torsion $\tau^a = -\tfrac{1}{2}c^a_{bc}\sigma^b \wedge \sigma^c$. (Frankel exercise.)
