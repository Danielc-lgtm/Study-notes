...
**Is an instance: the electromagnetic connection on a $U(1)$-bundle.** On the trivial complex line bundle $E = M \times \mathbb{C}$, the operation $\nabla_X s = X(s) + i A(X) s$ for a real 1-form $A$ on $M$ is a connection. Its curvature 2-form is $F = i\,dA$, the electromagnetic field strength. This is the geometric formulation of electromagnetism in **Gauge Theory I**, and it is the prototype of the Yang-Mills gauge potential.
