...
This exercise complements [[Ex - Self-Duality of the Electromagnetic Tensor in Minkowski]] (which examines the eigenvalue structure of $\star$ on $F$) and previews [[Gauge Theory VII — The Hodge Star, Electrodynamics, and Yang–Mills Theory]] (where the form-language $d_A\star F = 0$ generalizes Maxwell to non-abelian gauge [[Def - Group|groups]]).
