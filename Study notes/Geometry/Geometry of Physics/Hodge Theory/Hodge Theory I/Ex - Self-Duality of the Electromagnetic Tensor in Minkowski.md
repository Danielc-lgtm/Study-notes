...
The Lorentzian case has no real self-dual instantons (by part (b)). Riemannian instantons are obtained by **Wick rotation** $t \to it$, converting Lorentzian Minkowski into Euclidean $\mathbb{R}^4$. The Yang–Mills instantons of [[Gauge Theory VII — The Hodge Star, Electrodynamics, and Yang–Mills Theory]] live in the Wick-rotated (Riemannian) setting.
