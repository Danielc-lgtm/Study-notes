...
The Lorentzian case has no real self-dual instantons (by part (b)). Riemannian instantons are obtained by **Wick rotation** $t \to it$, converting Lorentzian Minkowski into Euclidean $\mathbb{R}^4$. The Yang–Mills instantons of [[Gauge Theory V — Hodge Theory, Maxwell, Yang–Mills, and Instantons]] live in the Wick-rotated (Riemannian) setting.
