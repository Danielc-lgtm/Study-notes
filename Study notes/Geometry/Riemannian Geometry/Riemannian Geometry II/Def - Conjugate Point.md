...
The motivating question is: **where along a geodesic does the local Riemannian theory break down, and what is the precise geometric content of that breakdown?** The local theory works inside a region where the exponential map is a diffeomorphism — there we have normal coordinates, a smooth distance function, and a guarantee that geodesics minimise. The *boundary* of this region is the **conjugate locus**, and conjugate points are the parameters at which the locus is hit.
