...
3. **Real-analysis operation: closed bounded subsets of $\mathbb{R}$ attain sup and inf.** This is the extreme-value theorem in dimension $1$ (or its set-theoretic version: closed sets attain their bounds).
