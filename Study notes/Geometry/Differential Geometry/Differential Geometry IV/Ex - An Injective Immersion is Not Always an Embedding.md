...
**Density of the irrational line — a Lie-theoretic phenomenon.** The one-parameter subgroup generated by $(1,\alpha)$ in $T^2$ is dense in the whole torus when $\alpha$ is irrational. More generally, a one-parameter subgroup is dense in its closure, and that closure is a closed connected abelian Lie subgroup—a subtorus—but a nonclosed subgroup of an arbitrary Lie group need not be dense in the entire group. This example motivates the distinction between immersed and embedded Lie subgroups: the closed subgroup theorem makes closed subgroups embedded, while nonclosed subgroups can be merely immersed.
