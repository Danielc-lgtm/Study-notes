...
The integer $k$ is the **[[Def - Dimension|dimension]]** of $S$ (necessarily $0 \leq k \leq n$), and $n - k$ is its **codimension**. An embedded $1$-codimensional submanifold is an **embedded hypersurface**.
