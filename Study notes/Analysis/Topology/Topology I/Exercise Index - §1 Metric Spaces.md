...
- [[Ex - Sup metric versus L1 metric on C01]] (⭐⭐) — comparing two metrics on the same set via identity-map continuity, with the escaping-mass counterexample showing non-equivalence ([[Def - Metric Space]], [[Def - Equivalent Metrics]], [[Def - Open and Closed Sets in a Metric Space]], [[Def - Continuous Map]]).
