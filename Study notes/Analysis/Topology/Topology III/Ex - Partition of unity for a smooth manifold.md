...
[[Thm - Locally Compact σ-Compact Hausdorff is Paracompact|**LC + $\sigma$-compact + Hausdorff ⇒ paracompact**]]. The standard manifold definition makes $M$ Hausdorff, locally compact (since $\mathbb{R}^n$ is locally compact and charts are diffeomorphisms onto open subsets), and second countable, hence $\sigma$-compact.
