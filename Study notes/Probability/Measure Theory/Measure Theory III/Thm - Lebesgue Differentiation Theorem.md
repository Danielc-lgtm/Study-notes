...
**Targets.** The conclusion gives: **Lebesgue points** (a.e. $x$ satisfies even $\frac{1}{\lambda(B(x,r))}\int_{B(x,r)}|f-f(x)|\to0$); the **density theorem** — for measurable $E$, a.e. point of $E$ has density $1$ in $E$; and the a.e. differentiability of the indefinite integral, the FTC for Lebesgue integrals.
