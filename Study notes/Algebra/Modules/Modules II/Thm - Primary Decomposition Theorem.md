...
Now the key fact, and it is a fact about the *[[Def - Ring|ring]]*, not the module. $R$ is a Euclidean domain, and Euclidean domains are unique factorisation domains. So every non-zero non-unit $d_i$ has a prime factorisation
