...
**Is an instance: $A_n$, the alternating group, for any $n$.** As a [[Def - Subgroup|subgroup]] of $S_n$ it is itself a group, and being a [[Def - Kernel and Image|kernel]] it is a [[Def - Normal Subgroup|normal subgroup]] of $S_n$. For $n \geq 5$ it is the first family of non-abelian [[Def - Simple Group|simple]] [[Def - Group|groups]]; see [[Thm - Simplicity of the Alternating Group]]. Note $A_3 = \{\operatorname{id}, (1\,2\,3), (1\,3\,2)\} \cong C_3$ is cyclic, and $A_4$ has order $12$.
