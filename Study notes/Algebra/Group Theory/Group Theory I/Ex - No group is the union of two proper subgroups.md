...
Prove that a group is never the union of two proper subgroups. That is, if $H$ and $K$ are subgroups of a group $G$ and $G = H \cup K$, then $H = G$ or $K = G$.
