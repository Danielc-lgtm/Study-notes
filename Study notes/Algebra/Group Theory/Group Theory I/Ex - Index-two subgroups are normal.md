...
Let $G$ be a [[Def - Group|group]] and let $H \leq G$ be a [[Def - Subgroup|subgroup]] of **index two**, that is, $|G : H| = 2$. Prove that $H$ is a normal subgroup of $G$, written $H \trianglelefteq G$.

**Recall:**

The objects in play are a subgroup, its [[Def - Coset|cosets]], and the notion of normality.
