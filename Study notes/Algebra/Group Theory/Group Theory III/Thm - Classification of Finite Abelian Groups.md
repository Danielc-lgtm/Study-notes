...
> **Classification of Finite Abelian Groups.** Let $G$ be a finite [[Def - Abelian Group|abelian]] group. Then there exist integers $d_1, d_2, \dots, d_r \geq 2$ such that
...
The theorem is **stated and used here, not proved from scratch**: its proof is deferred to the structure theorem for finitely generated modules over a principal ideal domain (later in the course), of which it is the case $R = \mathbb{Z}$. The "Formal Proof" section below explains why the deferral is the honest choice, and instead proves the part that genuinely belongs to this topic — the equivalence of the two forms.
...
1. **State the invariant-factor form and what uniqueness means.** Write $G \cong C_{d_1} \times \cdots \times C_{d_r}$ with $d_{i+1} \mid d_i$, and state that this list is unique; conclude $G \cong G'$ iff their lists agree.
...
<details>
<summary><strong>Lemma 1: Coprime cyclic factors fuse — the Chinese remainder step</strong></summary>
...
<details>
<summary><strong>Lemma 3: Elementary divisors reassemble into invariant factors — the column rule</strong></summary>
...
<details>
<summary><strong>Lemma 4 (the deferred input): existence and uniqueness of the invariant-factor decomposition</strong></summary>
