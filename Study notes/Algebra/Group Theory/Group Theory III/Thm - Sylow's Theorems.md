...
>
> **(II) — Conjugacy and containment.** Any two Sylow $p$-subgroups of $G$ are [[Def - Conjugacy Class|conjugate]] in $G$. More strongly, every [[Def - p-group|$p$-subgroup]] of $G$ is contained in some Sylow $p$-subgroup.
>
> **(III) — Count.** The number $n_p = |\operatorname{Syl}_p(G)|$ of Sylow $p$-subgroups satisfies
