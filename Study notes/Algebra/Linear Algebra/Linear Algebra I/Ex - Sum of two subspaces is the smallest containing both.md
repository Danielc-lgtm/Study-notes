...
Let $V_1, \dots, V_m$ be [[Def - Subspace|subspaces]] of a vector space $V$. Show that the sum $V_1 + \dots + V_m$ is itself a subspace of $V$, and that it is the **smallest** subspace of $V$ containing all of $V_1, \dots, V_m$.
