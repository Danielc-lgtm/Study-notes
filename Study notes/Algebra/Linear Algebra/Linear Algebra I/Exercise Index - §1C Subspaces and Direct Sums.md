...
- [[Ex - Intersection of subspaces is a subspace]] (⭐) — arbitrary intersection of subspaces is a subspace; drills the universally-quantified closure pattern that generalizes to subgroups, submodules, closed sets, $\sigma$-algebras ([[Def - Subspace]]).
