...
Let $V$ be a vector space over a field $\mathbb{F}$, and let $\{V_\alpha\}_{\alpha \in A}$ be an arbitrary (possibly infinite) family of [[Def - Subspace|subspaces]] of $V$. Show that the intersection
