...
> [!tip] Unlocked: Pseudoinverse for Underdetermined Systems *(from Numerical Linear Algebra)*
...
> [!tip] Unlocked: Cross-Validation *(from Machine Learning)*
