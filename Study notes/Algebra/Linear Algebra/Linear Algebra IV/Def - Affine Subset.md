...
The affine subsets $v + U$ are the *cosets* of $U$ as a subgroup of the additive group of $V$. That is, viewing $(V, +)$ as an [[Def - Abelian Group|abelian group]] and $U$ as a subgroup, the translates $v + U$ are exactly the [[Def - Coset|left cosets]] of $U$ in $V$. Since $V$ is abelian, left cosets and right cosets coincide.
