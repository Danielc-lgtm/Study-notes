...
- [[Ex - Operators on real odd-dimensional spaces have eigenvalues]] (⭐⭐⭐) — parity argument via the real factorisation theorem; uses an induction-by-2 on the [[Def - Dimension|dimension]] of an invariant subspace constructed from irreducible quadratic factors of $m_T$ ([[Thm - Eigenvalues are Zeros of the Minimal Polynomial]], [[Def - Minimal Polynomial]], [[Def - Division Algorithm and Factorization]], [[Def - Invariant Subspace]]).
