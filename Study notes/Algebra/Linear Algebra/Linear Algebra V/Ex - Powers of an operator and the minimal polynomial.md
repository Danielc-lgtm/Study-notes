...
**The minimal polynomial divides any [[Def - Annihilator|annihilator]]** (by [[Thm - Cayley-Hamilton (Minimal-Polynomial Form)]]): for any polynomial $q$, $q(T) = 0$ iff $m_T \mid q$.
...
>
> Not all of these are typical: for instance, $m_T = (z - i)$ would correspond to $T = iI$, but $T = iI$ has $T^2 = -I \neq I$ and $T^4 = (iI)^4 = i^4 I = I$, consistent. Similarly each case is realizable as some operator (with appropriate [[Def - Dimension|dimensions]] of eigenspaces summing to $4$).
