...
>
> To show $\hat\Gamma$ is an isomorphism, it suffices (by equal [[Def - Dimension|dimensions]] $\dim V \otimes V = 4 = \dim M_2(\mathbb{F})$) to show $\hat\Gamma$ is surjective. Equivalently, every $2 \times 2$ matrix is in the image.
>
