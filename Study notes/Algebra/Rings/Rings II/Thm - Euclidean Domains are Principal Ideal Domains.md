...
>
> > [!note]- Full proof
> > Since $b \in I$ and $I$ is an ideal, $I$ absorbs multiplication by arbitrary ring elements, so $bq \in I$ for every $q \in R$. Since $a \in I$ and $bq \in I$, and $I$ is an additive subgroup of $R$ (hence closed under subtraction), $a - bq \in I$. So the remainder $r := a - bq$ in any division $a = bq + r$ with $a, b \in I$ satisfies $r \in I$.
