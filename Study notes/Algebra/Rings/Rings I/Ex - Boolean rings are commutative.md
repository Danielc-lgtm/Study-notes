...
(Note: at this point $R$ is *not* assumed commutative — the ring axioms guarantee an abelian [[Def - Group|group]] under $+$ and an associative, distributive, unital multiplication, but not $xy = yx$.)
