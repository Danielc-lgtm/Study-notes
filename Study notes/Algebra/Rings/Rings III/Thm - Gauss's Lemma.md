...
>
> ---
> **Conclusion.** For a primitive $f \in R[X]$, reducibility in $R[X]$ and reducibility in $F[X]$ are equivalent; equivalently, irreducibility in the two rings coincides. $\blacksquare$
