...
The four-potential is a **connection $1$-form on a principal $\mathrm{U}(1)$-bundle** over spacetime, and the field $F = dA$ is its **curvature** $2$-form. This is the structural identity that places electromagnetism inside **gauge theory**, and it is the cleanest way to understand the gauge freedom.
