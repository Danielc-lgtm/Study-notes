...
> [!tip] The Klein–Gordon Equation and Mass as a Casimir Invariant *(from Quantum Field Theory)*
> The mass-shell relation $P\cdot P = m^2c^2$ is the seed of relativistic quantum mechanics. Quantising the particle replaces the four-momentum by the operator $P_\mu \to i\hbar\partial_\mu$ — the covariant completion of the Schrödinger rules $E\to i\hbar\partial_t$, $\mathbf{p}\to -i\hbar\nabla$ — and substituting this into the mass-shell condition turns the algebraic constraint into the wave equation $(\Box + m^2)\phi = 0$, the **Klein–Gordon equation**, with $\Box = \partial_\mu\partial^\mu$. Its plane-wave solutions $e^{-iK\cdot X}$ obey the dispersion relation $K\cdot K = m^2$, the wave-four-vector form of the mass shell. The deeper statement is that the rest mass is a **Casimir invariant** of the **Poincaré group** — the symmetry group of Minkowski space, generated by translations, rotations and boosts. A Casimir is an operator built from the generators that commutes with *all* of them; here it is $P_\mu P^\mu$ itself. Because it commutes with every generator, it acts as a single fixed scalar on each irreducible representation, so $m^2$ is constant throughout any irreducible representation — and that is the representation-theoretic reason a particle has one definite, frame-independent mass. A particle is an irreducible representation of the Poincaré group, and its mass is the value of the Casimir that labels it.

> [!tip] From the Mass Shell to the Klein–Gordon Equation and the Poincaré Casimir *(from Quantum Field Theory)*
> Two facts about $P\cdot P = m^2$ deserve to be drawn out as the doorway into field theory. The first is *constructive*: the mass-shell condition is an algebraic equation, but quantum mechanics turns four-momentum into the differential operator $P_\mu \to i\hbar\partial_\mu$, and an algebraic equation in $P_\mu$ becomes a *differential* equation in the wavefunction — substituting into $P\cdot P = m^2$ produces $(\Box + m^2)\phi = 0$, the **Klein–Gordon equation**, the relativistic wave equation of a spinless particle. So the geometric statement "the four-momentum lies on a hyperboloid of radius $m$" and the dynamical statement "the field obeys a wave equation with mass $m$" are the same statement read in two languages, related by the quantisation rule. The second fact is *structural*: $m^2 = P_\mu P^\mu$ is a **Casimir invariant** of the **Poincaré group**, the ten-parameter group of spacetime translations, rotations and boosts that is the full symmetry of Minkowski space. A Casimir is a combination of the generators that commutes with *every* generator of the group; by Schur's lemma it is therefore constant on each irreducible representation. This is the precise reason a particle has one sharp, frame-independent mass: a particle *is* an irreducible representation of the Poincaré group, and its mass is the fixed value the Casimir $P_\mu P^\mu$ takes on that representation. The same logic identifies the only other label a particle can carry — a second Casimir, built from the Pauli–Lubanski vector, fixes the spin — which is why mass and spin, and nothing else, are the intrinsic labels of an elementary particle.
