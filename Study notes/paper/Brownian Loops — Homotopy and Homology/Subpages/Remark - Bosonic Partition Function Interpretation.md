...
> **In words:** the sum of the killed Brownian loop masses over all topological types that genuinely wrap at least one hole (excluding both the contractible class and the "peripheral" classes that just circle a puncture / cusp) is a specific value of the Selberg zeta function.
