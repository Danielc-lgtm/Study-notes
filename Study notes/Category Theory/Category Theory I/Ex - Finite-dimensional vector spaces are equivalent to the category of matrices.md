...
3. **Operation: refute isomorphism by an object-count mismatch** (topic page, Legal Operation 3). $\mathbf{Mat}_k$ has one object per dimension; $\mathbf{FinVect}_k$ has many.
