...
An [[Def - Equivalence of Categories|equivalence]] is data $(F, G, \eta, \varepsilon)$ with natural [[Def - Isomorphism|isomorphisms]] $\eta : 1_{\mathcal{C}} \cong GF$, $\varepsilon : FG \cong 1_{\mathcal{D}}$. An isomorphism of categories requires $GF = 1_{\mathcal{C}}$ and $FG = 1_{\mathcal{D}}$ as equalities.
