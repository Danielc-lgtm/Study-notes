...
(a) Construct natural comparison maps $\varphi_{X,Y}:k[X]\otimes_k k[Y]\to k[X\times Y]$ and $\varphi_0:k\to k[1]$, and show they are **[[Def - Isomorphism|isomorphisms]]**, so $k[-]$ is a **weak (strong)** [[Def - Weak and Lax Monoidal Functor|monoidal functor]].
