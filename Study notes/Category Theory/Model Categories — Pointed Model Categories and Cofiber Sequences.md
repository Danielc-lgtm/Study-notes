...
> [!tip] Unlocked: [[Def - Triangulated Category|Triangulated Category]] and the Octahedral Axiom *(from the next chapter)*
...
> A **t-structure** on a triangulated category carves out an abelian "heart," reconstructing an abelian category and organizing perverse sheaves and weight [[Def - Filtration|filtrations]]. t-structures presuppose the (pre-)triangulated structure built here.
