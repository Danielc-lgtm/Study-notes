...
2. Explain why this forces the [[Def - Pointed Model Category Suspension and Loop|suspension]] $\Sigma X$ to be defined as the **homotopy** pushout, and identify the cofibrant-replacement step that fixes the degeneracy.
