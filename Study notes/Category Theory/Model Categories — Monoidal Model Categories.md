...
> [!tip] Unlocked: Closed Symmetric [[Def - Monoidal Category|Monoidal Categories]] as Models of Linear Logic *(from Logic / Type Theory)*
...
> [!tip] Unlocked: Ring Spectra and Brave New Algebra *(from Stable [[Def - Homotopy|Homotopy]] Theory)*
...
> [!tip] Unlocked: Symmetric Monoidal Structure on a [[Def - Triangulated Category|Triangulated Category]] *(from Stable Homotopy / Derived Algebra)*
