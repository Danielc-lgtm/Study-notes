...
2. **Motivation** — why this topic exists, what problems it solves. Written in David-Tong-style flowing prose (multiple paragraphs). Required elements:
...
9. **Formal Proof** — complete proof in a collapsible section. When the theorem has well-posedness preconditions (e.g. "the quotient exists", "the integral converges"), open the proof with **"Step 0 — [precondition]"** verifying it, separately from the substantive proof — see `Thm - First Isomorphism Theorem.md` for the pattern.
